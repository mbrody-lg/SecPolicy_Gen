...
def get_context_and_prompt(context_id: str) -> dict:
    ...
    # Primary source is the context document generated by the context agent.
    refined_prompt = (context.get("refined_prompt") or "").strip()

    # Backward-compatibility fallback for historical contexts that persisted
    # refined prompt only in interactions.
