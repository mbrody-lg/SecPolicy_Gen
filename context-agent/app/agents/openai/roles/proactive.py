...
Rules:
- Preserve the phase intent exactly: INTAKE, CONTEXT UPDATE, PLANNING,
  EXECUTION, or Policy Agent handoff.
- Preserve explicit user facts, field names, task ids, revision ids, hashes,
